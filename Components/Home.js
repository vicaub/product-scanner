...
class MyHomeScreen extends Component {
    ...
    _displayProductInfo = (productId) => {
        this.props.navigation.navigate("Product", {productId: productId});
    };
    ...
    render() {
        return (
            <View style = { styles.homeContainer }>
                ...
                <Button style={{ height: 50 }} title="Rechercher" onPress={() => this._displayProductInfo(3)} />
            </View>
        );
    }
}
